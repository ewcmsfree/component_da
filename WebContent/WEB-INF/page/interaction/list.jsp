    ...
    <div id="container">
      ...
      <div class="out_line">
        <div class="in_line">
          ...
          <p class="page_num">
            <span>共<s:property value="page.pageCount"/>页</span>
            <s:url id="pageFirstUrl" value="/interaction/list/page/%{type}_0_%{currentTable}.html" escapeAmp="false"/>
            <a href="<s:property value="pageFirstUrl"/>">第一页</a>
            <s:if test="page.pagePrev==-1"><span>上一页</span></s:if>
            <s:else>
            <s:url id="pagePrevUrl" value="/interaction/list/page/%{type}_%{page.pagePrev-1}_%{currentTable}.html" escapeAmp="false"/>
            <a href="<s:property value="pagePrevUrl"/>">上一页</a>
            </s:else>
            ...
            <s:else>
            <s:url id="pageNextUrl" value="/interaction/list/page/%{type}_%{page.pageNext-1}_%{currentTable}.html" escapeAmp="false"/>
            <a href="<s:property value="pageNextUrl"/>">下一页</a>
            </s:else>
            <s:url id="pageLastUrl" value="/interaction/list/page/%{type}_%{page.pageListAll.length}_%{currentTable}.html" escapeAmp="false"/>
            <a href="<s:property value="pageLastUrl"/>">最后页</a>
                      转到
            <select name="select" onchange="jumppage(this)">
