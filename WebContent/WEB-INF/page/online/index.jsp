...
<!--当前位置层-->
<div class="pos_box">
<p class="position"><span>当前位置：</span><a href="/">首页</a>&nbsp;>>&nbsp;在线办事<p>
</div>
<!--当前位置层结束-->
<!--内容层-->
	...
	<s:iterator value = "workings" id="working" status="st">
	    ...
	    <ul class="bs_list">
	        <s:iterator value="children" id="child">
	           ...
	           <s:param name="parentId" value="#working.id"/></s:url>
	           <li><a href="<s:property value="url"/>" target="_blank" >
	               <s:property value="#child.name"/></a></li>
	            </s:if>              
	         </s:iterator>         
	    </ul>
	    <div class="clearfloat"></div>
